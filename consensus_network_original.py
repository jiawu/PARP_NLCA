...
messed_up_jobs = []
list_of_dirs = os.listdir("/projects/p20519/jia_output/parpjuly2014/")
entries = []
list_of_dicts = []
T0T3list_of_dicts = []
T3T6list_of_dicts = []
...
for dir in list_of_dirs:
  try:
    fullpath = "/projects/p20519/jia_output/parpjuly2014/" + dir + "/CNO/Scaffold.complete.sif"
    #print fullpath
    with open(fullpath, "r") as input_file:
      for line in input_file:
        entry = line.rstrip('\n')
        entries.append(entry)
    T0T3_path = "/projects/p20519/jia_output/parpjuly2014/" + dir + "/CNO/ReportFromT0ToT3/EvolutionFit.txt"
    T3T6_path = "/projects/p20519/jia_output/parpjuly2014/" + dir + "/CNO/ReportFromT3ToT6/EvolutionFit.txt"
    T6T9_path = "/projects/p20519/jia_output/parpjuly2014/" + dir + "/CNO/ReportFromT6ToT9/EvolutionFit.txt"
    T9T24_path = "/projects/p20519/jia_output/parpjuly2014/" + dir + "/CNO/ReportFromT9ToT24/EvolutionFit.txt"
